...
class lcd:
    ...
    def __init__(self, i2cbus, address):
        self.device = i2c_device(i2cbus, address)
   ...
   # put string function with optional char positioning
    ...
    def write_string(self, string):
        if self.cursor_pos[0] == 0:
            pos_new = self.cursor_pos[1]
        if self.cursor_pos[0] == 1:
            pos_new = 0x40 + self.cursor_pos[1]
        if self.cursor_pos[0] == 2:
            pos_new = 0x14 + self.cursor_pos[1]
        if self.cursor_pos[0] == 3:
            pos_new = 0x54 + self.cursor_pos[1]
